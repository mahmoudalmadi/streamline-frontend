    ...
    useEffect(()=>{
        ...
        const rejectLessonRequest = async(id) => {
            ...
            if(lessonInfo.length==1){
                if(lessonInfo[0].status.toLowerCase()=="available"){
...

                        {
                            ...
                            <div className="h-full flex flex-col items-center justify-center">
                                ...
                                <div className="flex flex-1 h-full text-center mt-[50%] font-bold text-gray-500 text-[18px]">
                                    This trial lesson request has already been answered. Please go to your team dashboard to view your trial lessons schedule.
                                </div>
