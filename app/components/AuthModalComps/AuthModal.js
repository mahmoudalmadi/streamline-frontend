...
const AuthModal = ({ isOpen, onClose, isLogin ,switchModalType, isModal}) => {
  ...
  return (
    ...
    : "flex items-center justify-center"}>
      <div className=
      {isModal?"relative flex flex-col bg-white p-[25px] px-[10px] max-h-[650px] overflow-y-auto rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.1)] w-[440px] max-w-[90%] items-center":
